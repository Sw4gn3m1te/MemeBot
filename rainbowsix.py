...
class RainbowSix:
    ...
    def draw_ranked(self):
        ...
        d.text((10, 400), "Operation Grim Sky", fill=(1, 1, 1), font=font)
        d.text((10, 470), "Operation Wind Bastion", fill=(1, 1, 1), font=font)
        d.text((10, 540), "Operation Burnt Horizon", fill=(1, 1, 1), font=font)
        d.text((10, 610), "Operation Phantom Sight", fill=(1, 1, 1), font=font)
        d.text((10, 680), "Operation Ember Rise", fill=(1, 1, 1), font=font)
        d.text((10, 750), "Operation Shifting Tides", fill=(1, 1, 1), font=font)
        d.text((10, 820), "Operation Void Edge", fill=(1, 1, 1), font=font)

        font = ImageFont.truetype("arial.ttf", 15)
        for i in range(0, 820, 70):
